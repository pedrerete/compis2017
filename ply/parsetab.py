...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','ejemplo.py',61),
  ('statement -> expression','statement',1,'p_statement_expr','ejemplo.py',65),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','ejemplo.py',69),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','ejemplo.py',70),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','ejemplo.py',71),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','ejemplo.py',72),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','ejemplo.py',79),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','ejemplo.py',83),
  ('expression -> NUMBER','expression',1,'p_expression_number','ejemplo.py',87),
  ('expression -> NAME','expression',1,'p_expression_name','ejemplo.py',91),
]
